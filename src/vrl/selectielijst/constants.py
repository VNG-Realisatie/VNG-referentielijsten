...
class Procestermijnen(DjangoChoices):
    nihil = ChoiceItem(
        'nihil', _("Nihil"),
        extra_context=_("Er is geen aparte procestermijn, de bewaartermijn start direct na de procesfase.")
    )
    bestaansduur_procesobject = ChoiceItem(
        'bestaansduur_procesobject',
        _("De bestaans- of geldigheidsduur van het procesobject."),
        extra_context=_("De lengte van de procestermijn is afhankelijk van het procesobject. "
    ...
    ingeschatte_bestaansduur_procesobject = ChoiceItem(
        ...
        extra_context=_("Er wordt een inschatting gemaakt van de maximale bestaans- of "
    ...
    samengevoegd_met_bewaartermijn = ChoiceItem(
        ...
        extra_context=("De procestermijn en bewaartermijn zijn samengevoegd als "
